function [betamse,msemin,Er] = get_stat(datmatuse2d,latlist,a)
if ~exist('a','var')
    a=0.8;
end
...
sigmae = 1; %mm/day
% disp(location_list)
precipp = datmatuse2d; % this is the data matrix [t=months,location]
T = size(precipp,1);
N = size(precipp,2);
...
% mean observation
pmean = mean(precipp,1); % this is the mean of observations across months
